...
const Auth = () => {
  ...
  const [loadingState, setLoadingState] = useState<"idle" | "form" | "google" | "reset">("idle");
  const { signIn, signUp, signInWithGoogle, requestPasswordReset, user } = useAuth();
                  ...
                  <>
                    ...
                    <div className="mt-6 space-y-5">
                      ...
                      >
                        ...
                        {loadingState === "google" ? "Redirecting to Google..." : "Continue with Google"}
                      </Button>
